...
def create_forest_plot(data, pooled_p, lower_ci, upper_ci):
    ...
    ax.text(-0.19, len(data) + 1.5, r'\underline{\textbf{Study}}', fontsize=10, verticalalignment='top')
    ax.text(-0.135, len(data) + 1.5, r'\underline{\textbf{Proportions (95\%CI)}}', fontsize=10, verticalalignment='top')
